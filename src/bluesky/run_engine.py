...
class SingleRunExecutor:
    ...
    def __init__(
        ...
        self.run_start_uids: list[typing.Any] = list()  # run start uids generated by __call__  # noqa: C408
        ...
        self.metadata_per_call: dict[typing.Any, typing.Any] = {}  # for all runs generated by one __call__
        self.groups: defaultdict[str, set[Callable[[], asyncio.Future]]] = defaultdict(
            set
    ...
    async def _run(self):
        ...
        try:
            ...
            for key, current_run in self.run_bundlers.items():
    ...
    async def _open_run(self, msg):
        ...
        md = ChainMap(
            self.metadata_per_call,  # from kwargs to self.__call__
    ...
    async def _wait(self, msg: Msg) -> bool:
        ...
        futs = self.groups.pop(group, set())
        if futs:
            ...
            try:
                ...
                if watch:
                    ...
                    watch_futs = set()
                    for w in watch:
                        watch_futs.update(self.groups.get(w, set()))
    ...
    def _status_object_completed(self, ret, fut: asyncio.Future, pardon_failures):
        ...
        p_event : asyncio.Event
            held in the RunEngine's self.groups cache for waiting
    ...
    def _add_status_to_group(self, obj: typing.Any, status_object: Status, group: str, action: str) -> None:
        ...
        self.groups[group].add(lambda: fut)
...
class RunEngine:
    ...
    def md_normalizer(self):
        return self._single_run_executor.md_normalizer
    ...
    def _clear_run_cache(self):
        ...
        self._single_run_executor.groups.clear()
    ...
    def _create_result(self, plan_return):
        ...
        """
        rs = RunEngineResult(
            tuple(self._single_run_executor.run_start_uids),
            plan_return,
            self._single_run_executor.exit_status,
            self._interrupted,
            self._reason,
            self._single_run_executor.exception,
        )
        return rs
