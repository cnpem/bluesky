        ...
        try:
            ...
            while True:
                ...
                if not self.re_instance._run_permit.is_set():
                    ...
                    # clean up.
                    for obj in self.re_instance._objs_seen:
                ...
                try:
                    ...
                    if stashed_exception is None:
                        await asyncio.sleep(0, **self.re_instance._loop_for_kwargs)
                    ...
                    self.re_instance._objs_seen.add(msg.obj)
...
class RunEngine:
    ...
    def __init__(
        ...
        *,
        ...
        self._sre_objs: list[SingleRunEngine] = []
