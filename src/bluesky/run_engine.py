...
class SingleRunExecutor:
    ...
    async def run(self):
        ...
        # TODO: this can be removed because the task
        # can be accessed directly from __call__... maybe
        with self._state_lock:
...
class RunEngine:
    ...
    def rewindable(self, v: bool) -> None:
        ...
        if self.resumable and self.state_cache.rewindable_flag != cur_state:
    ...
    def resumable(self):
        ...
        return self.state_cache.msg_cache is not None
    ...
    def __call__(
        ...
        **metadata_kw: typing.Any,
        ...
        def _build_task():
            ...
            def set_blocking_event(_: "concurrent.futures.Future[typing.Any]") -> None:
