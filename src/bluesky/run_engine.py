...
class RunEngine:
    ...
    def _clear_run_cache(self):
        ...
        self._single_run_executor.clear_run_cache()

        # These are not used inside the Run Engine
    ...
    def _create_result(self, plan_return):
        ...
        rs = RunEngineResult(
            ...
            self._single_run_executor.interrupted,
            self._reason,
    ...
    def __call__(
        ...
        **metadata_kw: typing.Any,
        ...
        if self._single_run_executor.interrupted:
